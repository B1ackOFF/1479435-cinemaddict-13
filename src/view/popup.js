export const createPopupTemplate = (films) => {
  const {id, title, rating, release, duration, genre, poster, description, comments, ageRating, director, writers, actors, country} = films;
    ...
    <div class="film-details__top-container">
      ...
      <div class="film-details__info-wrap">
        <div class="film-details__poster">
          <img class="film-details__poster-img" src="./images/posters/${poster}" alt="${title.original}">
        ...
        <div class="film-details__info">
          ...
          <table class="film-details__table">
            ...
            <tr class="film-details__row">
              ...
              <td class="film-details__cell">--30 March 1945--${release}</td>
            </tr>
            <tr class="film-details__row">
            ...
            <tr class="film-details__row">
              ...
              <td class="film-details__cell">
                ...
                <span class="film-details__genre">--Mystery--${genre}</span></td>
            </tr>
          </table>
